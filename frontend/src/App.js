        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="text-center">
                <div className="text-3xl font-bold text-orange-600 dark:text-orange-400">8.5+ CGPA</div>
                <div className="text-sm text-gray-600 dark:text-gray-400">Academic Performance</div>
              </div>
            </div>
          </motion.div>
...
function App() {
  ...
  useEffect(() => {
  // Initialize dark mode on app load (default to dark)
